...
protocol EmojiCreation {
    func create(_ emojiGroup: (String, String))
}
...
class ShoppingViewController: UIViewController {
    ...
    var emojis: [(String, String)] = [] { didSet { tableView.reloadData() } }
...
extension ShoppingViewController : EmojiCreation {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
       if let dest = segue.destination as? EmojiSelectionViewController {
